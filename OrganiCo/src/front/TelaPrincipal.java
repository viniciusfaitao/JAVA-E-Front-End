...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Organi.Co");

        jButton4.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jButton4.setLabel("Cadastrar Produto");
        ...
        jButton6.setText("Realizar Venda");
        ...
        jButton8.setText("Relatorio de Vendas");
        ...
        jButton5.setText("Listar Produtos");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        if(ManipularFuncoes.vendas.isEmpty()){
            JOptionPane.showMessageDialog(this,"Nenhuma venda registrada!!");
        }else{
            TelaRelatorioDeVendas tela = new TelaRelatorioDeVendas();
            tela.setVisible(true);
        }
